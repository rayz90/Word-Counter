...
public class StopWordFilter implements Filter {
   ...
   public StopWordFilter() {
       // List retreived from http://armandbrahaj.blog.al/2009/04/14/list-of-english-stop-words/
       // on 2011-12-16 
       String[] stopword = {"a", "about", "above", "above", "across", "after", "afterwards", 
   ...
   public String filter(String word) {
       if(Arrays.binarySearch(this.stopwords, word) >= 0)
           return null;
       return word;
   }
}
